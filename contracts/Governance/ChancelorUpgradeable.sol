 ...
 */
abstract contract ChancelorUpgradeable is
    Initializable,
    ContextUpgradeable,
    ERC165Upgradeable,
    EIP712Upgradeable,
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    DoubleEndedQueueUpgradeable.Bytes32Deque private _chancelorCall;
     ...
     */
    function __Chancelor_init(string memory name_) internal onlyInitializing {
        __EIP712_init_unchained(name_, version());
        __Chancelor_init_unchained(name_);
    }

    function __Chancelor_init_unchained(string memory name_)
        internal
        onlyInitializing
    {
        _name = name_;
        ...
        returns (bool)
    {
        ...
        return
            interfaceId ==
            (type(IChancelorUpgradeable).interfaceId ^
                this.castVoteWithReasonAndParams.selector ^
                this.castVoteWithReasonAndParamsBySig.selector ^
                this.getVotesWithParams.selector) ||
            interfaceId == type(IChancelorUpgradeable).interfaceId ||
