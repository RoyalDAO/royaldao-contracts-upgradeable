...
// RoyalDAO Contracts (last updated v1.0.0) (Governance/extensions/SenateSecurityUpgradeable.sol)
    ...
    ReentrancyGuardUpgradeable
{
     ...
     * @dev Set the senate.
     */
    function __SenateSecurity_init(uint256 _quarantinePeriod)
        internal
        onlyInitializing
    {
    ...
    function __SenateSecurity_init_unchained(uint256 _quarantinePeriod)
        internal
        onlyInitializing
    {
        //set deputy mandate
