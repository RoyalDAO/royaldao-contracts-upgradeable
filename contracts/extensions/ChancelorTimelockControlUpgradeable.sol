 ...
 */
abstract contract ChancelorTimelockControlUpgradeable is
    Initializable,
    ...
    ChancelorUpgradeable
{
     ...
     */
    function __ChancelorTimelockControl_init(
        TimelockControllerUpgradeable timelockAddress
    ) internal onlyInitializing {
        __ChancelorTimelockControl_init_unchained(timelockAddress);
    }

    function __ChancelorTimelockControl_init_unchained(
        TimelockControllerUpgradeable timelockAddress
    ) internal onlyInitializing {
